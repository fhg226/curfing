...
<%@ include file = "../includes/header.jsp" %>    
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class ='row'> <!-- row 태그 안에 안착시키기 위해서 -->
                             <div class = "col-lg-12"> <!-- col-lg는 12칼럼으로 이루어져있는데 -12 는 12개를 다 쓴다는 의미 -->
                              <form id ='searchForm' action="/board/list" method='get'>
                            	<select name = 'type'>
                            	 ...
                            	 >제목 or 내용 or 글쓴이</option> <!-- pageMaker.cri 문구들이 들어간 이유는 검색할때 남기기 위해서 -->
                            	</select>
  ...
  <%@ include file ="../includes/footer.jsp" %>     
			...
			<script type="text/javascript"> //값을 넘겨준 번호값이 언제까지 있나 확인하는 것
